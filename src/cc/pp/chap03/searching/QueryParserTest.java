...
public class QueryParserTest extends TestCase {
	...
	public void testTermRangeQuery() throws Exception {
		...
		Query query = new QueryParser(Version.LUCENE_30, "sunject", analyzer). //
				parse("title2:[Q TO V]");
	...
	public void testPhraseQuery() throws Exception {
		...
		Query query = new QueryParser(Version.LUCENE_30, "field", //
				new StandardAnalyzer(Version.LUCENE_30)).parse("\"This is Some Phrase*\"");
	...
	public void testLowercasing() throws Exception {
		...
		Query query = new QueryParser(Version.LUCENE_30, "field", analyzer).parse("PrefixQuery*");
	...
	public void testWildcard() throws ParserException {
		try {
			new QueryParser(Version.LUCENE_30, "feild", analyzer).parse("*xyz");
	...
	public void testBoost() throws ParseException {
		...
		Query query = new QueryParser(Version.LUCENE_30, "field", analyzer).parse("term^2");
